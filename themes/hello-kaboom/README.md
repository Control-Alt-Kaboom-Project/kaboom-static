...
![Hello Friend kaboom](images/screenshot.png)
...
You can see it in action here: https://kaboom.net
...
You can download the theme manually by going to [https://github.com/kaboom/hugo-theme-hello-kaboom.git](https://github.com/kaboom/hugo-theme-hello-kaboom.git) and pasting it to `themes/hello-kaboom` in your root directory.

You can also clone it directly to your Hugo folder:

``` bash
$ git clone https://github.com/kaboom/hugo-theme-hello-kaboom.git themes/hello-kaboom
```

If you don't want to make any radical changes, it's the best option, because you can get new updates when they are available. To do so, include it as a git submodule:

``` bash
$ git submodule add https://github.com/kaboom/hugo-theme-hello-kaboom.git themes/hello-kaboom
```
...
<a href="https://www.buymeacoffee.com/kaboom" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-green.png" alt="Buy Me A Coffee" style="height: 51px !important;width: 217px !important;" ></a>
